...
const DEFAULT_CONTENT = {
  nav:{logoName:'Joshlee Solutions Africa',logoTagline:'Developing Solutions for The Future',links:[{label:'Home',href:'#home'},{label:'About',href:'#about'},{label:'Services',href:'#services'},{label:'Products',href:'#products'},{label:'Clients',href:'#clients'},{label:'Values',href:'#values'}],ctaLabel:'Get in Touch',ctaHref:'#contact'},
